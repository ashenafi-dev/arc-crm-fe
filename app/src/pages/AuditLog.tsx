    ...
    <div className="space-y-5">
      ...
      <GlassCard className="p-5">
        <div className="space-y-4">
          {events.map((e) => (
            <div key={e.id} className="flex gap-3 border-b border-white/5 pb-4 last:border-0 last:pb-0">
              <div className="mt-1 h-2 w-2 shrink-0 rounded-full bg-[var(--gold-500)]" />
              <div>
