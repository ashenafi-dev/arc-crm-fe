...
import { Check, CircleDot, FilePlus2, History, PackageCheck, ShoppingBag, X, type LucideIcon } from 'lucide-react'
...
export function AuditLog() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader title="Audit log" count={events.length} subtitle="Every action on every request. Read-only, nobody can edit history." />
